...
const { addIngredient, updateIngredient, deleteIngredient, getAllIngredients } = IngredientController;
const { admin } = PermissionsData;

router.post('/', authenticate, verifyRoles(admin), isVerified, onAddIngredient, addIngredient);
router.patch('/edit', authenticate, verifyRoles(admin), isVerified, ingredientCheck, updateIngredient);
router.delete('/', authenticate, verifyRoles(admin), isVerified, ingredientCheck, deleteIngredient);
